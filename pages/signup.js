        ...
        <div className="w-full bg-gray-100">
          <div className="container mx-auto py-8 bg-gray-100">
            <div className="w-11/12 lg:w-1/3 mx-auto bg-white rounded shadow">
              <div className="py-4 px-8 text-black text-xl border-b border-gray-lighter">Register</div>
              <form onSubmit={onSubmit}>
                <div className="py-4 px-8">
                  {/* <div className="flex mb-4">
                    <div className="w-1/2 mr-1">
                      <label className="block text-gray-darker text-sm font-bold mb-2" htmlFor="first_name">First Name</label>
                      <input className="appearance-none border rounded w-full py-2 px-3 text-gray-darker" id="first_name" type="text" placeholder="Your first name" />
                    </div>
                    <div className="w-1/2 ml-1">
                      <label className="block text-gray-darker text-sm font-bold mb-2" htmlFor="last_name">Last Name</label>
                      <input className="appearance-none border rounded w-full py-2 px-3 text-gray-darker" id="last_name" type="text" placeholder="Your last name" />
                    </div>
                  </div> */}
                  <div className="mb-4">
                  ...
                  <span className="text-red-600 bg-black">{errors}</span>
            ...
            <p className="text-center my-4">
              <a href="/signin" className="text-blue-500 text-sm no-underline hover:text-blue-600">I already have an account. Sign in?</a>
            </p>
          </div>
        </div>
        {/* Footer */}
