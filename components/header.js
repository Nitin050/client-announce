  ...
  return(
    ...
    <span className="text-white">{user}nm
      {userEmail ?
        ...
        :
        <Link href='/signin'>
          <a className='lg:inline-flex lg:w-auto w-full px-3 py-2 rounded text-white items-center justify-center hover:text-white hover:bg-blue-600'>
            Login
          </a>
        </Link>
      }
